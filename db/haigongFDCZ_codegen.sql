DROP DATABASE IF EXISTS `haigongFDCZ_codegen`;

CREATE DATABASE  `haigongFDCZ_codegen` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;

USE haigongFDCZ_codegen;
